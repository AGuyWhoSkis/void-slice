# M2.5 · Production Deploy

**Status:** todo  
**Goal:** M2  
**Size:** small  
**Blocks:** nothing (final M2 milestone)
...
**Steps:**
1. Trigger the main branch CI/CD pipeline (M2.4) and confirm it deploys cleanly
...
**L4 architecture (resolved by M2.7):**
...
M2.4 (CI/CD pipeline must run end-to-end successfully at least once), M2.7 (WASM spike — determines L4 architecture), M2.8 (resource profile — confirms linter fits within Workers limits and informs upload size cap)
